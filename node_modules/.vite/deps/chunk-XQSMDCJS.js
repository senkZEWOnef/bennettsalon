...
var Fe = G(() => {
  ...
  a(S, "Socket"), E(S, "defaults", {
    ...
    fetchEndpoint: a((t, n, i) => {
      let s;
      return (i == null ? void 0 : i.jwtAuth) ? s = t.replace(yi, "apiauth.") : s = t.replace(yi, "api."), "https://" + s + "/sql";
    }, "fetchEndpoint"),
...
var Gs = T((Mt) => {
  ...
  var k = ln(), qc = js(), wn = 1, Qc = 4, Hs = wn + Qc, $s = d.allocUnsafe(0), bn = class bn {
    constructor(e) {
      if (this.buffer = $s, this.bufferLength = 0, this.bufferOffset = 0, this.reader = new qc.BufferReader(), (e == null ? void 0 : e.mode) === "binary")
      ...
      if (e.query += t[i], i < n.length) {
        ...
        if (o instanceof Ge)
          ...
          if (o.queryData instanceof gt2)
            ...
            if ((_a = o.queryData.params) == null ? void 0 : _a.length)
...
function cs(r, {
  ...
  async function Y(P, I, w) {
    ...
    let de = u;
    !Array.isArray(I) && (I == null ? void 0 : I.authToken) !== void 0 && (de = I.authToken);
...
var kn = class kn2 extends wo.Client {
  ...
  connect(t) {
    ...
    let i = typeof this.config != "string" && ((_a = this.config) == null ? void 0 : _a.host) !== void 0 || typeof this.config != "string" && ((_b = this.config) == null ? void 0 : _b.connectionString) !== void 0 || m.env.PGHOST !== void 0, s = m.env.USER ?? m.env.USERNAME;
...
var Un = class Un2 extends go.Pool {
  ...
  query(t, n, i) {
    ...
    try {
      ...
      cs(l, { fullResults: true, arrayMode: t.rowMode === "array" }).query(f, y, { types: t.types ?? ((_a = this.options) == null ? void 0 : _a.types) }).then((A) => i(void 0, A)).catch((A) => i(
        A
      ));
    } catch (o) {
      i(o);
...
@neondatabase/serverless/index.mjs:
  ...
  *)
*/
//# sourceMappingURL=chunk-XQSMDCJS.js.map
