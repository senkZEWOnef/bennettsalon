            ...
            <Col lg={6} className="order-2 order-lg-1">
              <div className="hero-content-welcome">
                ...
                <p className="hero-welcome-subtitle">
                  ...
                  Donde cada cliente es tratada como una obra de arte y cada
                  servicio es una experiencia única de elegancia y cuidado
                  personal.
                </p>
            ...
            <Col lg={12} className="text-center mb-5">
              <div className="services-header">
                ...
                <p className="services-subtitle">
                  Experiencias de belleza personalizadas en el corazón de
                  Aguada, Puerto Rico
                </p>
              </div>
            </Col>
          ...
          <Row>
            <Col lg={4} className="mb-5">
              <div className="elegant-service-card">
                ...
                <p className="elegant-service-description">
                  Una sesión colaborativa que mapea las necesidades únicas de
                  tus uñas, seguida de tratamientos personalizados y combinación
                  de colores para lograr un acabado impecable y listo para
                  fotografiar.
                </p>
                <div className="service-image-placeholder">
                  <img
                    src="/images/gallery/manicures/manicure2.jpg"
                    alt="Manicura Personalizada"
                    className="img-fluid"
                  />
                </div>
              </div>
            ...
            <Col lg={4} className="mb-5">
              <div className="elegant-service-card">
                ...
                <p className="elegant-service-description">
                  Estilismo integral para ocasiones especiales—maquillaje,
                  acabado de cabello ligero, y soporte en el sitio—adaptado a la
                  atmósfera, iluminación y tema de tu evento.
                </p>
                <div className="service-image-placeholder">
                  <img
                    src="/images/gallery/pedicures/pedicureRed.JPG"
                    alt="Pedicura de Evento"
                    className="img-fluid"
                  />
                </div>
              </div>
            ...
            <Col lg={4} className="mb-5">
              <div className="elegant-service-card">
                ...
                <p className="elegant-service-description">
                  Tratamientos progresivos enfocados en la vitalidad a largo
                  plazo de tus uñas, combinando exfoliación avanzada, terapia de
                  hidratación, y orientación de productos para una luminosidad
                  duradera.
                </p>
                <div className="service-image-placeholder">
                  <img
                    src="/images/gallery/manicures/manicureclassic.jpg"
                    alt="Renovación y Brillo"
                    className="img-fluid"
                  />
                </div>
              </div>
